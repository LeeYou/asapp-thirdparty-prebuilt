...
set_target_properties(SQLite::asapp_sqlite3 PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libasapp_sqlite3.a"
  )

list(APPEND _cmake_import_check_targets SQLite::asapp_sqlite3 )
list(APPEND _cmake_import_check_files_for_SQLite::asapp_sqlite3 "${_IMPORT_PREFIX}/lib/libasapp_sqlite3.a" )
